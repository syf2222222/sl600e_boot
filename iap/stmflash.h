...
//#define ADDR_FLASH_SECTOR_12		((unsigned int)0x08100000) 	//扇区12起始地址, 16 Kbytes  
//#define ADDR_FLASH_SECTOR_13		((unsigned int)0x08104000) 	//扇区13起始地址, 16 Kbytes  
//#define ADDR_FLASH_SECTOR_14  	((unsigned int)0x08108000) 	//扇区14起始地址, 16 Kbytes  
//#define ADDR_FLASH_SECTOR_15		((unsigned int)0x0810C000) 	//扇区15起始地址, 16 Kbytes  
//#define ADDR_FLASH_SECTOR_16  	((unsigned int)0x08110000) 	//扇区16起始地址, 64 Kbytes  
//#define ADDR_FLASH_SECTOR_17		((unsigned int)0x08120000) 	//扇区17起始地址, 128 Kbytes  
//#define ADDR_FLASH_SECTOR_18		((unsigned int)0x08140000) 	//扇区18起始地址, 128 Kbytes  
//#define ADDR_FLASH_SECTOR_19		((unsigned int)0x08160000) 	//扇区19起始地址, 128 Kbytes  
//#define ADDR_FLASH_SECTOR_20		((unsigned int)0x08180000) 	//扇区20起始地址, 128 Kbytes  
//#define ADDR_FLASH_SECTOR_21		((unsigned int)0x081A0000) 	//扇区21起始地址, 128 Kbytes  
//#define ADDR_FLASH_SECTOR_22		((unsigned int)0x081C0000) 	//扇区22起始地址, 128 Kbytes  
//#define ADDR_FLASH_SECTOR_23		((unsigned int)0x081E0000) 	//扇区23起始地址, 128 Kbytes   
 
//unsigned int STMFLASH_ReadWord(unsigned int faddr);		  	//读出字  
//int STMFLASH_Write(unsigned int WriteAddr,unsigned int *pBuffer,unsigned int NumToWrite,unsigned int TypeProgram);		//从指定地址开始写入指定长度的数据
